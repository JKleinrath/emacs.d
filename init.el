...
(custom-set-variables
 ...
 '(ivy-mode t)
 '(org-agenda-files (quote ("~/Dropbox/Apps/orgmode/2020_todo.org")))
 ...
 '(package-selected-packages
   (quote
    (org-bullets org-themis dired-sidebar org-sidebar speed-type real-auto-save undo-tree ivy doom-themes org-noter which-key org-download multiple-cursors org-re-reveal helm-orgcard helm-org helm-org-rifle helm magit)))
 '(save-place-mode t)
 '(show-paren-mode t))
(custom-set-faces
